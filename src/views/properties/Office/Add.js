...
class AddOfficeImage extends Component {
  constructor(props) {
    super(props)
    this.state = {
      id: '',
  ...
  handleFormSubmit(event) {
    ...
    // const url = '/prop/office/add_office_image.php'
    API({
      method: 'post',
      url: '/prop/office/add_office_image.php',
      data: formData,
...
export default withRouter(AddOfficeImage)
