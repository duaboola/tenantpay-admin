...
class AddVillaImage extends Component {
  constructor(props) {
    super(props)
    this.state = {
      id: '',
  ...
  handleFormSubmit(event) {
    ...
    // const url = '/prop/villa/add_villa_image.php'
    API({
      method: 'post',
      url: '/prop/villa/add_villa_image.php',
      data: formData,
...
export default withRouter(AddVillaImage)
