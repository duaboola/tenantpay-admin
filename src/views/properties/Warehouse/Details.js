...
class WarehouseDetails extends React.Component {
  ...
  componentDidMount() {
    API({
      ...
      url: '/prop/warehouse/warehouse_details.php?id=' + this.props.match.params.id.slice(1),
    })
  ...
  deleteWarehouse(id, event) {
    //alert(id)
    event.preventDefault()
    if (window.confirm('Are you sure want to delete?')) {
      API({
        method: 'get',
        url: '/prop/warehouse/admin_delete.php?id=' + id,
      })
  ...
  render() {
    if (this.state.red) {
      return <Navigate to="/properties/warehouse/list" />
    }
    return (
          ...
          <CContainer>
            <CRow className="align-items-start">
              <CCol>
                <p>
                  <Link
                    to={`/properties/warehouse/images:${this.state.id}`}
              ...
              <CCol>
                <p>
                  <Link
                    to={`/properties/warehouse/edit:${this.state.id}`}
              ...
              <CCol>
                <p>
                  <Link
                    to="#"
                    onClick={this.deleteWarehouse.bind(this, this.state.id)}
            ...
            <CTable align="middle" className="mb-0 border table-striped" hover responsive>
              ...
              <CTableBody>
                ...
                <CTableRow>
                  ...
                  <CTableDataCell>
                    <div>{this.state.warehouse_name}</div>
                  </CTableDataCell>
                </CTableRow>
                <CTableRow>
                  <CTableDataCell>
