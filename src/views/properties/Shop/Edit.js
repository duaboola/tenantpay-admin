...
class EditShop extends Component {
  ...
  componentDidMount() {
    API({
      ...
      url: '/prop/shop/admin_edit_shop.php?id=' + this.props.match.params.id.slice(1),
    })
  ...
  handleFormSubmit(event) {
    ...
    API({
      method: 'post',
      url: '/prop/shop/admin_update_shop.php',
      data: formData,
      ...
      .then(function (response) {
        ...
        alert('Shop Details are Successfully Updated.')
      })
