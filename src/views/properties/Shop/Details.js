...
class ShopDetails extends React.Component {
  ...
  componentDidMount() {
    API({
      ...
      url: '/prop/shop/shop_details.php?id=' + this.props.match.params.id.slice(1),
    })
  ...
  deleteShop(id, event) {
    ...
    if (window.confirm('Are you sure want to delete?')) {
      API({
        method: 'get',
        url: '/prop/shop/admin_delete.php?id=' + id,
      })
  ...
  render() {
    if (this.state.red) {
      return <Navigate to="/properties/shop/list" />
    }
    return (
          ...
          <CContainer>
            <CRow className="align-items-start">
              <CCol>
                <p>
                  <Link
                    to={`/properties/shop/images:${this.state.id}`}
              ...
              <CCol>
                <p>
                  <Link
                    to={`/properties/shop/edit:${this.state.id}`}
              ...
              <CCol>
                <p>
                  <Link
                    to="#"
                    onClick={this.deleteShop.bind(this, this.state.id)}
